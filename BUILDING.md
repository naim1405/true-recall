...
# Create ZIP package
cd ..
Compress-Archive -Path true-recall-v1.2\* -DestinationPath true-recall-v1.2.zip
```
...
5. **Attach files:**
   ...
   - `true-recall-v1.2.zip` (complete package)
6. Click **Publish release**

### Release Assets Checklist

- [ ] `true-recall.exe` - Standalone executable (~500KB)
- [ ] `true-recall-v1.2.zip` - Complete package with docs
- [ ] Source code archives (auto-generated by GitHub)
- [ ] Release notes from CHANGELOG.md

### What Users Get

- **Standalone exe** for quick download
- **ZIP package** with documentation
